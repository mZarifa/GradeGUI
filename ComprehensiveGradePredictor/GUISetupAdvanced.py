...
def save():
    text = e1.get() \
        ...
        \
         + "\n" + e26.get() \
        \
         + "\n" + e27.get() + " " + e28.get() + " " + e29.get() \
         + "\n" + e30.get() + " " + e31.get() + " " + e32.get()
...
e24.grid(row=9, column=0)
e25.grid(row=10, column=0)
e33.grid(row=11, column=0)

e26.grid(row=12, column=1)
e27.grid(row=12, column=1)
e28.grid(row=12, column=2)
e29.grid(row=12, column=3)
e30.grid(row=13, column=1)
e31.grid(row=13, column=2)
...
Label(master, text="Click save, then click run").grid(row=30)
